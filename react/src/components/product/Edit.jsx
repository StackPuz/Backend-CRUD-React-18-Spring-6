          ...
          <form method="post" onSubmit={edit} encType="multipart/form-data">
            <div className="row">
              ...
              <div className="form-group col-md-6 col-lg-4">
                ...
                <select id="product_brand_id" name="brand.id" className="form-control form-control-sm" onChange={onChange} value={(product.brand && product.brand.id) || '' } required>
                  <option></option>
              ...
              <div className="form-group col-md-6 col-lg-4">
                ...
                <a href={`http://localhost:8080/app/uploads/products/${product.image || '' }`} target="_blank" rel="noreferrer" title={`${product.image || '' }`}><img className="img-item" src={`http://localhost:8080/app/uploads/products/${product.image || '' }`} /></a>
