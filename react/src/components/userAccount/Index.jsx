            ...
            <table className="table table-sm table-striped table-hover">
              <thead>
                <tr>
                  ...
                  <th className={Util.getSortClass('email') + ' d-none d-md-table-cell' }>
                    <Link to={Util.getLink(paging,'sort','email')}>Email</Link>
                  </th>
                  <th className={Util.getSortClass('active')}>
                    <Link to={Util.getLink(paging,'sort','active')}>Active</Link>
                  </th>
                  <th>Actions</th>
                </tr>
              </thead>
