# Backend-CRUD-React-18-Spring 6
Boilerplate Backend CRUD Web App created with React 18 + Spring 6 by [StackPuz](https://stackpuz.com).
...
## Installation
1. Clone this repository. `git clone https://github.com/stackpuz/Backend-CRUD-React-18-Spring-6.git .`
2. Change directory to React project. `cd Backend-CRUD-React-18-Spring-6/react`
